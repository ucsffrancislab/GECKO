...
def helpMessage() {
    ...
    nextflow run 01_decomposition.nf --reads '*.bam'
...
process bam2fastq{
    ...
    """
    samtools fastq $reads > ${prefix}.fastq
    """
...
if(params.notrim){
    ...
    process trim_galore {
        ...
        """
        $softPath/trim_galore --dont_gzip --fastqc $c_r1 $c_r2 $tpc_r1 $tpc_r2 $reads
        """
